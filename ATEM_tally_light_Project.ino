...
#define TALLY_FLAG_PROGRAM              2
#define TALLY_FLAG_PREVIEW              1
    ...
    switch (state) {
        case STATE_CONNECTING_TO_WIFI:
            if (WiFi.status() == WL_CONNECTED) {
                ...
                Serial.println("------------------------");
                Serial.println("Connected to WiFi:   " + String(getSSID()));
        ...
        case STATE_CONNECTING_TO_SWITCHER:
            if (firstRun) {
                ...
                Serial.println("Switcher IP:         " + String(settings.switcherIP[0]) + "." + String(settings.switcherIP[1]) + "." + String(settings.switcherIP[2]) + "." + String(settings.switcherIP[3]));
                firstRun = false;
            }
